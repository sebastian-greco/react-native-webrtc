...
class UvcCameraSession implements UsbCameraSession {
            ...
            try {
                ...
                camera.setStatusCallback(new IStatusCallback() {
                    ...
                    public void onStatus(final int statusClass, final int event, final int selector,
                        ...
                        Log.e("relabo.UsbDevice.Status", "onStatus(statusClass=" + statusClass
                                + "; " +
                                "event=" + event + "; " +
                                "selector=" + selector + "; " +
                ...
                camera.setButtonCallback(new IButtonCallback() {
                    ...
                    public void onButton(final int button, final int state) {
                        Log.e("relabo.UsbDevice.Status", "onButton(button=" + button + "; " + "state=" + state + ")");
                    }
                });
    ...
    private UvcCameraSession(Events events, Context applicationContext, SurfaceTextureHelper surfaceTextureHelper, @Nullable MediaRecorder mediaRecorder, CameraEnumerationAndroid.CaptureFormat captureFormat, long constructionTimeNs) {
        Log.d(TAG, "Create new camera1 session on usb camera");
    ...
    public void stop() {
        Log.d(TAG, "Stop camera1 session on usb camera");
    ...
    {
        Log.e(TAG, stoped + ":" + UvcCameraSession.SessionState.STOPPED);
        if (stoped) return;
